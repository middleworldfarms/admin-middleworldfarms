...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                /*
                 * Disable file backup for now to focus on database
                 */
                'include' => [
                    // Temporarily disable file backup
                ],
             ...
             * Start with just Laravel database, add others when confirmed working
             */
            'databases' => [
                'mysql',
                // Enable these once WordPress/farmOS/POS connections are confirmed working:
                // 'wordpress',  // WordPress database
                // 'farmos',     // farmOS database  
                // 'pos_system', // POS system database
            ],

            /*
             * The timeout for database dumps in seconds
             */
            'timeout' => 60,

            /*
             * The database dump can be compressed with gzip
             */
            'gzip' => false,
        ],
