...
// SIMPLE FIX: Ensure step progression works
document.addEventListener('DOMContentLoaded', function() {
    const cropSelect = document.getElementById('cropType');
    const step2Section = document.getElementById('step2Section');
    
    if (cropSelect && step2Section) {
        cropSelect.addEventListener('change', function() {
            if (this.value) {
                console.log('Crop selected:', this.value, '- Showing step 2');
                ...
                if (step2Badge) step2Badge.className = 'badge bg-primary me-2';
                if (step2Text) step2Text.className = 'step-text';
            }
        });
        console.log('Simple step progression fix added');
    }
});
